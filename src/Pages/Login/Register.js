...
import register from '../../images/register-removebg-preview (1).png'
                       ...
                       <Typography variant="h4" sx={{fontFamily:"italic",fontWeight:'bold'}} gutterBottom component="div">
                        REGISTER  
                            ...
                            sx={{ width: '75%', m: 1 }}
                                ...
                                onChange={handleChange}
                                /><br/><br/> 
                            <Button  variant="contained" type="submit" sx={{ width: '75%', m: 1,bgcolor:"#607d8b",p:2}}>Register Now</Button>    <br/><br/>
